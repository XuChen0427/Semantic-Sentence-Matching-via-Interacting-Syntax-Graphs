...
if 'SPHINX' not in os.environ:
    ...
    sparse_dot = load(name='sparse_dot',
                      sources=['GMutil/extension/sparse_dot/sparse_dot.cpp',
                               'GMutil/extension/sparse_dot/csr_dot_csc_cuda.cu',
                               'GMutil/extension/sparse_dot/csr_dot_diag_cuda.cu'],
                      extra_include_paths=[
                          'usr/include/python{}.{}/'.format(sys.version_info.major, sys.version_info.minor)],

                      )
    print('/usr/include/python{}.{}/'.format(sys.version_info.major, sys.version_info.minor))
